...
#         func_channel = self._device.functionalChannels[self._channel_index]
...
#         return int(
#             (self._device.functionalChannels[self._channel_index].dimLevel or 0.0) * 255
#         )
...
#                 kwargs[ATTR_BRIGHTNESS] / 255.0, self._channel_index
#             )
#         else:
#             await self._device.set_dim_level(1, self._channel_index)

#     async def async_turn_off(self, **kwargs: Any) -> None:
#         """Turn the dimmer off."""
#         await self._device.set_dim_level(0, self._channel_index)
...
#         if channel == 2:
#             super().__init__(
#                 hap, device, post="Top", channel_index=channel, is_multi_channel=True
#             )
#         else:
#             super().__init__(
#                 hap, device, post="Bottom", channel_index=channel, is_multi_channel=True
#             )
