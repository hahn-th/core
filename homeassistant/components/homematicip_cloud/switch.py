...
#         return self._device.functionalChannels[self._channel_index].on

#     async def async_turn_on(self, **kwargs: Any) -> None:
#         """Turn the switch on."""
#         await self._device.turn_on(self._channel_index)

#     async def async_turn_off(self, **kwargs: Any) -> None:
#         """Turn the switch off."""
#         await self._device.turn_off(self._channel_index)
