...
#     def current_cover_position(self) -> int | None:
#         """Return current position of cover."""
#         if self._device.functionalChannels[self._channel_index].shutterLevel is not None:
#             return int(
#                 (1 - self._device.functionalChannels[self._channel_index].shutterLevel) * 100
#             )
#         return None
...
#         # HmIP cover is closed:1 -> open:0
#         level = 1 - position / 100.0
#         await self._device.set_shutter_level(level, self._channel_index)
...
#         if self._device.functionalChannels[self._channel_index].shutterLevel is not None:
#             return (
#                 self._device.functionalChannels[self._channel_index].shutterLevel
#                 == HMIP_COVER_CLOSED
#             )
#         return None
...
#     async def async_open_cover(self, **kwargs: Any) -> None:
#         """Open the cover."""
#         await self._device.set_shutter_level(HMIP_COVER_OPEN, self._channel_index)

#     async def async_close_cover(self, **kwargs: Any) -> None:
#         """Close the cover."""
#         await self._device.set_shutter_level(HMIP_COVER_CLOSED, self._channel_index)

#     async def async_stop_cover(self, **kwargs: Any) -> None:
#         """Stop the device if in motion."""
#         await self._device.set_shutter_stop(self._channel_index)
...
#     def current_cover_tilt_position(self) -> int | None:
#         """Return current tilt position of cover."""
#         if self._device.functionalChannels[self._channel_index].slatsLevel is not None:
#             return int(
#                 (1 - self._device.functionalChannels[self._channel_index].slatsLevel) * 100
#             )
#         return None
...
#         # HmIP slats is closed:1 -> open:0
#         level = 1 - position / 100.0
#         await self._device.set_slats_level(slatsLevel=level, channelIndex=self._channel_index)

#     async def async_open_cover_tilt(self, **kwargs: Any) -> None:
#         """Open the slats."""
#         await self._device.set_slats_level(
#             slatsLevel=HMIP_SLATS_OPEN, channelIndex=self._channel_index
#         )

#     async def async_close_cover_tilt(self, **kwargs: Any) -> None:
#         """Close the slats."""
#         await self._device.set_slats_level(
#             slatsLevel=HMIP_SLATS_CLOSED, channelIndex=self._channel_index
#         )
